...
/* emails/flat_match.html.twig */
class __TwigTemplate_683b0bb3c7655de9da70106390708c03 extends Twig_Template
{
    ...
    <p>A new advert has been placed on Christian Flatshare which we think may be of interest to you:</p>
    <p><strong><a href=\"";
        // line 7
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["offered"]) ? $context["offered"] : null), "url"), "html", null, true);
        echo "\">";
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["offered"]) ? $context["offered"] : null), "title"), "html", null, true);
        echo "</a></strong></p>
    <p>This Flat-Match email has been sent in response to your wanted accommodation advert:</p>
    <p><strong><a href=\"";
        // line 9
...
";
    ...
    {
        return "emails/flat_match.html.twig";
    }
