...
<div id="canvas">
	...
	<div id="content">
		...
		<div id="how to post an advert" class="header_no_image">
				<h1 class="mb5"><span>Offering Accommodation</span></h1>
				<!-- <h2 class="mt0"><span>posting adverts and some helpful tips...</span></h2> -->
		</div>	
		<div class="two_column_canvas">
		<div class="col1"><br/>
		<h2 class="mb5 mt0">Posting Offered Accommodation adverts</h2>
			<p class="mt0">To post an advert you must first <a href="how-to-join-cfs.php">join</a> Christian Flatshare(CFS). The key to posting a good advert is to take care to put helpfully detailed descriptions and to add photos, both which help encourage advert responses. </p>
	      <p>Once you have logged in, on the right hand side you will the member's menu where you can click &quot;<strong>Post an Accommodation Advert!</strong> &quot;. Click of &quot;Offered accommodation ad&quot; and choose: </p>
	      <ul>
	      ...
	      <p>Follow the steps in the advert form to post your advert. </p>
	      <p>Anytime afterwards you can go to &quot;Your ads&quot; (top right corner) where your advert(s) are listed and where you can: </p>
			  <ul>
			    ...
			    <p class="mt0">Any Wanted Accommodation adverts that match your offered accommodation will be shown below your advert summary, on the Your ads page. We recommend that you look at and reply to any of the adverts you think are suitable. </p>
			    <p>&nbsp;</p>
			    <p><br />
			    </p>
		</div>
		<div class="col2"><br/>
			...
			<p class="mt0"> If you enter the postcode of accommodation you have to offer in the Quick Search on the front page you will be shown those wanted ads who are looking for accommodation in your postcode, which you can reply to.<br />
			  <br />
			  If you have placed a offered accommodation advert a link to it will automatically be included in your reply.</p>
			...
			<ol class="mb0">
				...
				<li><strong>Regularly logging</strong> in to CFS will help others see you are actively using CFS as your advert(s) will show how many days since you last logged in.</li>
...
<p>
  Read further on:<br />
        ...
        <!--<a href="facebook-your-ad.php">Facebook your ad</a><br/>	-->
        <a href="frequently-asked-questions.php"></a><a href="frequently-asked-questions.php">Frequently Asked Questions</a><br/>
</div>
		<div class="cc0"><!----></div>
	</div>
