...
var _INITIAL_WIDTH			= 320;		// Initial width of the box (px)
var _INITIAL_HEIGHT			= 240;		// Initial height of the box (px)
var _CONTENTS_WIDTH 		= 320;		// Actual width of the box (px)
var _CONTENTS_HEIGHT		= 240;		// Actual height of the box (px)
var _DEF_CONTENTS_WIDTH		= 640;		// Default width of the box (px) - used for resetting when a different setting was used
var _DEF_CONTENTS_HEIGHT	= 480;		// Default height of the box (px) - used for resetting when a different setting was used
