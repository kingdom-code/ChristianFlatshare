...
<title>How to post an advert - Christian Flatshare</title>
<!-- InstanceEndEditable -->
...
<div id="canvas">
	...
	<div id="content">
		...
		<div id="how to post an advert" class="header_no_image">
				<h1 class="mb5"><span>How to post an advert</span></h1>
				<h2 class="mt0"><span>joining CFS, posting adverts and some cool tips...</span></h2>
		</div>	
		...
		<div class="col1">
			...
			<ol>
				<li>Click on &quot;<a href="register.php" target="_blank">Click here to join</a>&quot;, here or on the front page, and complete the membership form. Here will be asked to provide an email address (which acts as your member name) and a password.</li>
				<li>CFS will send you an <strong>email with a link </strong>in it. You need to click on this link to confirm your email address and activate your account. Check that this email is not sent to your junk mail folder.<br />
					You can now login to CFS, where you can post your advert. </li>
			</ol>
			<h2 class="m0"><span>How to post an advert</span></h2>
			<p class="mt0"> To post an advert you must first become a member of CFS (see above).</p>
		  <p> Once logged in, on the right hand side you will the member's menu on the right, where you can choose to post adverts:
		    <br />
			- <strong>Offered accommodation </strong> (if you have accommodation to offer)<br />
- <strong>Wanted accommodation</strong> (if you are looking for accommodation)</p>
			<p>The advert posting process is then in two steps:</p>
			<ol>
				<li><strong>Advert text</strong> - complete the form to complete the main body of your advert. You can edit your advert and add more text any time later once your ad is posted.</li>
				<li><strong>Add photos </strong> - here you can add photos, you can do this later also by editing your advert. </li>
				<li></li>
			    <li><strong>
		        Your ads </strong>- at this stage your advert is complete and will appear on the CFS. &quot;Your ads&quot; is where your advert(s) are listed and where you can:
                  <ul>
					  <li><strong>Upload photos</strong></li>
					  ...
					  <li> Change your advert's picture </li>
					</ul>
			    </li>
			</ol>
		</div>
		<div class="col2">
			...
			<ol class="mb0">
				...
				<li>If you have a <strong>website </strong>or a social-networking page, then including a link to it will help others to find out more about you.</li>
   ...
   <p>Read further on:<br />
	        <a href="how-to-look-for-accommodation.php">Looking for accommodation?</a><br/>
